# Coverage run — tb_fsm (FSM transition coverage)
transcript on
...
vlog -sv -work work +incdir+D:/Thesis101/hardware/../testbench {D:/Thesis101/hardware/testbench/tb_fsm.v}

# -onfinish stop: testbench calls $finish; keep sim alive so coverage save runs.
vsim -coverage -onfinish stop -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L cov_work -L work -voptargs="+acc +cover=bcefsx" tb_fsm
run -all
coverage save cov_fsm.ucdb
quit -f
