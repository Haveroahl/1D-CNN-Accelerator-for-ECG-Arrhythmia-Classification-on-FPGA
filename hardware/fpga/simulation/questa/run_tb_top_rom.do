...
# V1 hard-ROM build: +define+WEIGHT_ROM selects the FF-array ROM weight store
# (no bus, fixed Chapman topology). tb_top compiles out TC08-TC10 (bus/config).
...
vlog -sv -work work +define+WEIGHT_ROM +incdir+D:/Thesis101/hardware/RTL {D:/Thesis101/hardware/RTL/cp_weight_store.v}
