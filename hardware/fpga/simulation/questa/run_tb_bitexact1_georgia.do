...
# RTL/ = ban ROM single-load (weight ningba bake $readmemh). tb_bitexact1 chay 1
# mau, so 7 checkpoint bit-exact. +SAMPLE=8 = golden Georgia (cross-dataset,
# zero-shot tren cung weight ningba). Log dau phai in "sample 8".
...
vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc" tb_bitexact1 +SAMPLE=8
