...
## 2. Cross-dataset Chapman↔PTB-XL — `results/cross_eval/ptbxl_cross_eval.json`
PTB-XL: 19,952 records, 500→250Hz, lead II, patient-indep 70/15/15.
...
**Key finding**: C2 == C6 → quantization drop = **0%**; toàn bộ drop là distribution shift.
> ⚠️ PROJECT.md ghi C3=0.9249/C4=0.9329; JSON thật = C3 0.9263 / C4 0.9336. **Dùng số JSON.**
> Trong ICDV cross-dataset chỉ để **1 đoạn ngắn** (không phải tâm bài) — đủ tăng giá trị.
...
## 7. Năng lượng (PowerPlay) — 🔲 PHẦN CÒN THIẾU / CẦN XÁC NHẬN
